        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-primary-100">
              Training and certifications for ministry volunteers and staff
            </p>
            <div className="space-x-4">
              <Link to="/catalog" className="btn-primary bg-white text-primary-600 hover:bg-gray-50">
                Browse Catalog
              </Link>
