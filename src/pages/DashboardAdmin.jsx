    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="card">
          <div className="card-body">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Certifications Issued</p>
                <p className="text-2xl font-semibold text-gray-900">{stats.totalCertifications}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link to="/admin/certifications" className="card hover:shadow-lg transition-shadow">
            <div className="card-body text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Certification Rules</h3>
              <p className="text-sm text-gray-600">Manage certifications</p>
            </div>
          </Link>


          <Link to="/admin/announcements" className="card hover:shadow-lg transition-shadow">
            <div className="card-body text-center">
              ...
              <p className="text-sm text-gray-600">System announcements</p>
            </div>
          </Link>
